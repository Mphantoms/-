      ...
      success: function (res) {
        ...
        wx.getImageInfo({
          ...
          success: function (res) {
            ...
            //Math.sqrt(x)
            if (originWidth * originHeight > 1920 * 1080) {
              maxWidth = Math.sqrt(1920 * 1080 * bit);
              maxWidth = Math.floor(maxWidth / 4) * 4;
              maxHeight = 1920 * 1080 / maxWidth;
              maxHeight = Math.floor(maxHeight / 4) * 4;
            }
